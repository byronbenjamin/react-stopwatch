...
var StopWatch = React.createClass({
  ...
  startStopButton: function() {
    ...
    return <TouchableHighlight
            onPress={this.handleStartPress} underlayColor="gray"
...
//border kept for reference. to include use style={this.border(color)} (above)
...
var styles = StyleSheet.create({
  ...
  buttonWrapper: { // Green
    flex: 3, // takes up 3/8ths of the available space 8 comes from 5 + 3
    flexDirection: 'row',
